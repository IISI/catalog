...
public class Rpt1600B implements IReport {
    ...
    public InputStream getReportFile() {
        return getClass().getResourceAsStream("/WEB-INF/report/Rpt1600B.jasper");
    }
    ...
    public Object getReportData() {
        WebRequest req = ((WebRequest) RequestCycle.get().getRequest());
        long functionLogId = Long.valueOf(req.getParameter("functionLogId"));
        return new JRMapCollectionDataSource(appFileDao.find1600BReportData(functionLogId));
    }
